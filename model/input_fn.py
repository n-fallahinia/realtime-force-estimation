...
def input_fn(is_training, filenames, labels, params = None):
    ...
    preproc_train_fn = lambda f, l: preprocess_data(f, l, params.image_size, params.use_random_flip, params.use_random_color)
    preproc_eval_fn = lambda f, l: preprocess_data(f, l, params.image_size, False, False)
